...
const services = ({servicesHead, servicesSub, service1, service2, service3, service4, service5, service6, servicesText}) => {
    return (
        ...
        <div className="services__cards-wrapper">
          <div className="services__card-wrapper">
            <img src="/public/images/users.png" alt="Services Icon" />
